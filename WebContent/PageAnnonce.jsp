...
function jsGetAge(strBirthday) {var returnAge;
			...
			if (nowYear == birthYear) {
				returnAge = 0;//Ã¥ÂÂŒÃ¥Â¹Â´ Ã¥ÂˆÂ™Ã¤Â¸Âº0Ã¥Â²Â  
			} else {
				var ageDiff = nowYear - birthYear; //Ã¥Â¹Â´Ã¤Â¹Â‹Ã¥Â·Â®  
				if (ageDiff > 0) {
					if (nowMonth == birthMonth) {
						var dayDiff = nowDay - birthDay;//Ã¦Â—Â¥Ã¤Â¹Â‹Ã¥Â·Â®  
						if (dayDiff < 0) {
							returnAge = ageDiff - 1;
						} else {
							returnAge = ageDiff;
						...
						var monthDiff = nowMonth - birthMonth;//Ã¦ÂœÂˆÃ¤Â¹Â‹Ã¥Â·Â®  
						if (monthDiff < 0) {
							returnAge = ageDiff - 1;
						} else {
							returnAge = ageDiff;
			    		...
			    		<!-- <div class="row top-margin-10">
			    				...
			    				<div class="col-md-6">
				    				<select  class="form-control input-sm" id="loisirNew">
										...
										<option value="28">théÃ¢tre</option>
